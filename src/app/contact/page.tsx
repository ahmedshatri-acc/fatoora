...
export const metadata: Metadata = {
  title: "تواصل معنا",
  description: "تواصل مع فريق دعم Wathq — نحن هنا للمساعدة في أي استفسار عن الفوترة الإلكترونية وزاتكا.",
};
    ...
    <LegalLayout title="تواصل معنا">
      ...
      <Section title="أسئلة شائعة قبل التواصل">
        <div className="space-y-4">
          {[
            {
              q: "هل فواتيري متوافقة فعلًا مع زاتكا؟",
              a: "نعم. جميع الفواتير المُولَّدة عبر Wathq تستوفي متطلبات المرحلة الثانية من الفوترة الإلكترونية بما فيها رمز QR بترميز TLV وضريبة القيمة المضافة 15%.",
            },
            {
